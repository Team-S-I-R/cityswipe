...
const actionPropsMatrix = {
  left: {
    ...
    bgColorClass: "bg-gradient-to-t from-red-400/60 to-orange-400/60 text-red-400 hover:text-white hover:from-red-400 hover:to-orange-400",
    icon: BadIcon,
    iconBaseColorClass: "text-white",
  },
  right: {
    ariaLabel: "Swipe Right",
    bgColorClass: "bg-gradient-to-t from-cyan-400/60 to-green-400/60 text-green-400 hover:text-white hover:from-cyan-400 hover:to-green-400",
    icon: GoodIcon,
    iconBaseColorClass: "text-white",
  },
};
