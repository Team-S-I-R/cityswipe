...
export default function SharedItineraryPage({ userId }: any) {
    ...
    async function handleSubmit (uId: string) { 
        ...
        try {
          ...
          const firstName = (data?.usersName || "").split(' ')[0];

          setItineraryData(itinerary);
          setUsersName(firstName.charAt(0).toUpperCase() + firstName.slice(1));
          ...
          setError('This itinerary could not be loaded. Please check the link or try again.');
          setItineraryIsLoading(false);
        }
    ...
    return (
        ...
        <div className="flex flex-col w-full h-[100dvh] place-items-center justify-between gap-6">
          ...
          <div className="text-transparent">
            ...
            {itineraryIsLoading === false && !error && (
